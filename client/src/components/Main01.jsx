  ...
  const handleStarClick = async (propertyId, rating) => {
    try {
      const response = await axios.post(
        `https://backend-henna-gamma.vercel.app/property/${propertyId}/rate`,
        {
          rating: rating,
          comment: "User rating",
        }
    ...
    const fetchProperties = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          "https://backend-henna-gamma.vercel.app/property",
          {
            params: {
              ...
              >
                <Link to={`/property/${property._id}`} className="block">
                  <div className="relative">
                    <img
                      src={`https://backend-henna-gamma.vercel.app/images/${property._id}/0`}
